        ...
        static const rclcpp::Logger LOGGER = rclcpp::get_logger("move_cl");
        ...
        int main(int argc, char **argv) {
          ...
          static const std::string PLANNING_GROUP_Grip = "hand";
          ...
          static const std::string PLANNING_GROUP_cl = "cl";
          moveit::planning_interface::MoveGroupInterface move_group_cl(move_group_node, PLANNING_GROUP_cl);
          ...
          moveit::planning_interface::MoveGroupInterface::Plan my_plan_hand; //grip plan
          moveit::planning_interface::MoveGroupInterface::Plan my_plan_cl; //cl plan
          ...
          moveit::core::RobotStatePtr current_state_cl = move_group_cl.getCurrentState(10);
          ...
          move_group_arm.setNamedTarget("scan_high");
...
//          RCLCPP_INFO(LOGGER, "Z pos is %f",current_pose.pose.position.z);
          ...
          success_grip = (move_group_grip.plan(my_plan_hand) == moveit::core::MoveItErrorCode::SUCCESS);
          move_group_grip.execute(my_plan_hand);

          move_group_cl.setNamedTarget("open");
          success_grip = (move_group_cl.plan(my_plan_cl) == moveit::core::MoveItErrorCode::SUCCESS);
          move_group_cl.execute(my_plan_cl);
