...
pkg_share = launch_ros.substitutions.FindPackageShare(package="test_bench_description").find("test_bench_description")
default_model_path = os.path.join(pkg_share, "urdf/Socket.urdf")
default_rviz2_path = os.path.join(pkg_share, "rviz/urdf_vis.rviz")
...
def launch_setup(context: launch.LaunchContext) -> typing.List[launch_ros.actions.Node]:
    ...
    robot_description = Command(
        [
            ...
            " ",
            PathJoinSubstitution([pkg_share, "urdf", "Socket.urdf"]),
            " ",
            # "arm:=",
